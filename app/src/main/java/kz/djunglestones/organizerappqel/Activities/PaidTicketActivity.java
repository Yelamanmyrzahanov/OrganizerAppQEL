...
public class PaidTicketActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,
        TimePickerDialog.OnTimeSetListener{
    private ConstraintLayout choose_sales_start_constraint;
    private Toolbar toolbar;
    private ConstraintLayout sales_end_constraint,by_date_and_time_constraint,visibility_constraint,check_box_constraint,sales_end_dates_constraint,fees_constraint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choose_sales_start_constraint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String[] dayOfWeekArr = PaidTicketActivity.this.getResources().getStringArray(R.array.startOfSalesArr);
                final TextView choose_date_and_time_tv = findViewById(R.id.choose_sales_start_tv);
                final AlertDialog.Builder builder = new AlertDialog.Builder(PaidTicketActivity.this);
                        ...
                        .setItems(R.array.startOfSalesArr, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (which==2){
                                    ...
                                    final AlertDialog.Builder builderTicketEnd = new AlertDialog.Builder(PaidTicketActivity.this);
        ...
        sales_end_constraint.setOnClickListener(v -> {
            final String[] salesEndArr = PaidTicketActivity.this.getResources().getStringArray(R.array.endOfSalesArr);
        ...
        visibility_constraint.setOnClickListener(v -> {
            final String[] visibilityChooseArr = PaidTicketActivity.this.getResources().getStringArray(R.array.visibilityChooseArr);
        ...
        fees_constraint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String[] feesChooseArr = PaidTicketActivity.this.getResources().getStringArray(R.array.feesChooseArr);
                final TextView choose_fees_tv = findViewById(R.id.fees_spinner_tv);
                final AlertDialog.Builder builder = new AlertDialog.Builder(PaidTicketActivity.this);
                builder.setTitle(R.string.feesChoose)
                        .setItems(R.array.feesChooseArr, (dialog, which) -> {
                            // The 'which' argument contains the index position
                            // of the selected item
                            choose_fees_tv.setText(feesChooseArr[which]);
                        });
                builder.create();
                builder.show();
            }
    ...
    private void initUI() {
        toolbar = findViewById(R.id.paid_tickets_toolbar);
        ...
        fees_constraint = findViewById(R.id.fees_constraint);
